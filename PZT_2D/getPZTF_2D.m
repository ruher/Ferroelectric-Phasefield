function [dG_k_Px,dG_k_Py]=getPZTF_2D(Px,Py,scale,ela_reduc_para)
    L=0.125e-6;
    T=298;
    d=(L/scale)^2;
    %%------------alpha------------%%
    ...
    dG_GL_k_Px=d*fft2(ifftshift(dG_GL_k_Px_alpha1+dG_GL_k_Px_alpha11+dG_GL_k_Px_alpha12+dG_GL_k_Px_alpha111+dG_GL_k_Px_alpha112));
    dG_GL_k_Py=d*fft2(ifftshift(dG_GL_k_Py_alpha1+dG_GL_k_Py_alpha11+dG_GL_k_Py_alpha12+dG_GL_k_Py_alpha111+dG_GL_k_Py_alpha112));
